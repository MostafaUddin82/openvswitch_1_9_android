...
{
	VLOG_DBG("dpif_flow_stats_extract \n");
	...
	stats->current_index=1; //mostafa
	stats->arrival_time[0]=used; //mostafa
...
{
	VLOG_DBG("dpif_flow_stats_format \n");
